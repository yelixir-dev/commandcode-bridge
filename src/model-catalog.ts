...
export const COMMANDCODE_MODEL_DEFINITIONS: CommandCodeModelDefinition[] = [
  ...
  },
  {
    ...
    notes: "OSS pool model exposed by CommandCode 0.40.3",
  },
  {
    ...
    provider: "MiniMax",
    family: "minimax",
    aliases: ["minimax-m3-free", "MiniMax-M3-Free"],
    enabledByDefault: false,
    notes: "OSS pool model exposed by CommandCode 0.40.3",
  },
  {
  ...
  },
  {
    ...
    family: "ling",
    aliases: ["ling-3.0-flash-free", "Ling-3.0-Flash-Free"],
    enabledByDefault: false,
